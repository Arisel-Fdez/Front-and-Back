...
function UpdateUsers(){
    ...
    const url=`http://localhost:3000/api/user/actualizar?id=${data.id}&username=${data.username}&email=${data.email}&password=${data.password}&phone_number=${data.phone_number}`
